...
- [ ] **Phase 1: Core Engine** - Multi-LLM support, advanced control flow, and storage abstraction
...
### Phase 1: Core Engine
**Goal**: Users can define and execute complex multi-provider workflows with branching, loops, and parallelism on a pluggable storage backend
...
Plans:
- [ ] 03-01: Chat UI for config generation (Gradio interface with session persistence and conversation history)
- [ ] 03-02: Orchestration dashboard (FastAPI + HTMX with agent discovery, MLFlow embed, real-time monitoring)
